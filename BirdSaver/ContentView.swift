        ...
        VStack(alignment: .leading, spacing: 8) {
            ...
            if taskIDs.isEmpty && showEmptyMessage && minimumRowCount == 0 {
                ...
                VStack(spacing: 0) {
                    ...
                    .frame(height: tableHeight(for: displayRowCount))
                    .clipped()
                }
    ...
    private var summarySection: some View {
        ...
        return VStack(alignment: .leading, spacing: 10) {
            HStack(spacing: 8) {
                ...
                summaryBadge(title: "TOTAL", value: counts.total, color: .accentColor, isLive: isSummaryRunning)
            }
    ...
    private var settingsSheet: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Stepper(value: $viewModel.maxConcurrentDownloads, in: 1...8) {
                Text("DL並列数: \(viewModel.maxConcurrentDownloads)")
                    .monospacedDigit()
            }
